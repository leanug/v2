  ...
  return (
    <section className="flex flex-col items-center justify-center mt-24">
      ...
      <p className="text-lg text-center mb-12 max-w-3xl leading-8">
        &quot;Ponyfly&quot; is a WordPress-based platform designed to facilitate
        seamless connections between travelers and customers. Through Ponyfly,
        travelers can offer products purchased abroad directly to interested
        buyers, creating a unique marketplace experience. Customers benefit from
        access to a curated selection of global products, while travelers can
        monetize their journeys by facilitating product deliveries.
      </p>
